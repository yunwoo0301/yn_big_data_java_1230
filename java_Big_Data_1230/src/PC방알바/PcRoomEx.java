...
public class PcRoomEx {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (pcRoom[seatNum - 1] == 1) { // 해당 배열의 값이 1이라는 건 이미 예약된 자리임. 인덱스는 0부터 시작하므로 -1을 해야함
                rejectCnt++; // 거절횟수가 겹칠 경우 횟수가 늘어나야되므로
            } else {
