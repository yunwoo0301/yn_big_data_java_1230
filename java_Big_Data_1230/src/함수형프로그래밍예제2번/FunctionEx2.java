...
// 메소드 참조 : 메소드 참조해서 매개변수의 정보 및 반환타입을 알아내어, 불필요한 매개변수를 제거함.
class Calculator {
    ...
    public int instanced(int x, int y) {
        return x + y;
    }

    public int instanceMethod(int i, int i1) {
        return i + i1; // 다시 체크
...
public class FunctionEx2 {
    public static void main(String[] args) {
        ...
        // 메소드 참조 방식
        operator = Calculator::staticMethod; // :: 소속(메소드 참조)
